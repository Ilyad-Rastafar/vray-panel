...
import (
	...
	"vray-panel/web/service"
	"vray-panel/web/session"
...
func (a *InboundController) getClientTrafficsEdited(c *gin.Context) {
	email := c.Param("email")
	clientTraffics, err := a.inboundService.GetClientTrafficByEmailEdited(email)
	if err != nil {
		jsonMsg(c, "Error getting traffics", err)
		return
	}
...
func (a *InboundController) resetClientTraffic(c *gin.Context) {
	...
	var err error
	needRestart, err = a.inboundService.ResetClientTraffic(email)
	if err != nil {
